...
st.set_page_config(page_title="H R Analytics Dashboard!!!",page_icon=":bar_chart:",layout="wide")


st.title(":bar_chart: HR Analytics Dashboard!!!")

df=pd.read_excel("hrdata1.xlsx",sheet_name='HR-Data')
...
if not gender:
    ...
    fig4=px.funnel(table4,x='Job Role',y='CF_attrition count')
