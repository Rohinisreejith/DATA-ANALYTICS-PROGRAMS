...
st.set_page_config(page_title="Hitters salary prediction",page_icon=" :trophy: ",layout="wide")
st.title(" :sports_medal: Salary prediction fot Hitters :rugby_football: ")
