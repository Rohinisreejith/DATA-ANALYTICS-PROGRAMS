...
st.set_page_config(page_title="Hitters salary analysis",page_icon=" :moneybag: ",layout="wide")
st.title(" :sports_medal: Hitters Salary Data Analysis :rugby_football: ")

sdf = pd.read_csv("Hitters.csv")
st.subheader("Hitters Dataset")
