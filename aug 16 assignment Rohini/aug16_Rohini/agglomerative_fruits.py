...
fig1=px.scatter(df,x='mass',y='width',size='color_score',color='new_label1')
st.plotly_chart(fig1,use_container_width=True)

st.header("Visualizing the new label2 and clusters")
fig2=px.scatter(df,x='mass',y='width',size='color_score',color='new_label2')
st.plotly_chart(fig2,use_container_width=True)

st.header("Visualizing the new label3 and clusters")
fig3=px.scatter(df,x='mass',y='width',size='color_score',color='new_label3')
...
m1=pickle.dump(agg1,open('agg1.pkl','wb'))
m2=pickle.dump(agg2,open('agg2.pkl','wb'))
m3=pickle.dump(agg3,open('agg3.pkl','wb'))